    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-1">
                <div className="text-md md:text-lg font-bold">{user.username}</div>
                <div className={`font-medium text-xs md:text-sm italic ${textColor}`}>
                    {user.isAdmin ? "Admin" : "Regular User"}
                </div>
            </div>
            <div className="border-t border-gray-300 pt-2 flex flex-col text-sm md:text-base">
            ...
            <div className="flex-1 flex justify-around mt-4 text-sm md:text-base">
                <Link
