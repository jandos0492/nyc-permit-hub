...
const AutoEnglishExpressTestCard = ({
    randomEnglishData,
    index,
    ...
    useEffect(() => {
        ...
        if (
            randomEnglishData.correctAnswerIndex === selectedAnswer &&
    ...
    useEffect(() => {
        if (selectedAnswer === randomEnglishData.correctAnswerIndex) {
            setCountCorrectAnswers((prevCount) => prevCount + 1);
        }
    }, [
        selectedAnswer,
        randomEnglishData.correctAnswerIndex,
        setCountCorrectAnswers,
    ]);
...
export default AutoEnglishExpressTestCard;
