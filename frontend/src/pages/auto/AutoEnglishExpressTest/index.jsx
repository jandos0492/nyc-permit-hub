...
const AutoEnglishExpressTest = () => {
    ...
    const handleSubmit = () => {
        testResult.sendTestResult({
            ...
            testLanguage:
                "https://algify-videos.s3.https://algify-videos.s3.us-east-2.amazonaws.com/nyc-permit-hub-images/english-flag.jpg-east-2.amazonaws.com/nyc-permit-hub-images/english.jpg",
