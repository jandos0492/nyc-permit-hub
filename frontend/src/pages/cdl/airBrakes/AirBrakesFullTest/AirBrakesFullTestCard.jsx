...
const AirBrakesFullTestCard = ({
    ...
    useEffect(() => {
        ...
        if (
            airBrakesFullTestCard.correctAnswerIndex ===
                selectedAnswer &&
    ...
    }, [airBrakesFullTestCard.correctAnswerIndex, selectedAnswer]);

    useEffect(() => {
        if (
            selectedAnswer === airBrakesFullTestCard.correctAnswerIndex
        ) {
...
export default AirBrakesFullTestCard;
