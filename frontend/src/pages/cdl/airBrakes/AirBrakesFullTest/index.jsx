...
import AirBrakesFullTestCard from "./AirBrakesFullTestCard";
...
const AirBrakesFullTest = () => {
    const [airBrakesFullTestData, setAirBrakesFullTestData] =
        useState([]);
    const [isLoading, setIsLoading] = useState(false);
    const [airBrakesFullTestIdx, setAirBrakesFullTestIdx] =
        useState(0);
    ...
    useEffect(() => {
        const handleKeyDown = (event) => {
            if (event.key === "ArrowLeft" && airBrakesFullTestIdx > 0) {
                setAirBrakesFullTestIdx((prevIdx) => prevIdx - 1);
            } else if (
                event.key === "ArrowRight" &&
                airBrakesFullTestIdx <
                    airBrakesFullTestData.length - 1 &&
                selectedAnswers[
                    airBrakesFullTestData[airBrakesFullTestIdx].id
                ] !== undefined
            ) {
                setAirBrakesFullTestIdx((prevIdx) => prevIdx + 1);
            }
                    ...
                    >
                        ...
                        <div className="flex justify-center items-center">
                            <NavButton
                                ...
                                onClick={() =>
                                    setAirBrakesFullTestIdx(
                                        airBrakesFullTestIdx - 1
                                    )
                                }
                                show={airBrakesFullTestIdx > 1000}
                            />
...
export default AirBrakesFullTest;
