...
const GeneralKnowledgeFullTestCard = ({
    ...
    useEffect(() => {
        ...
        if (
            generalKnowledgeFullTestCard.correctAnswerIndex === selectedAnswer &&
    ...
    useEffect(() => {
        if (selectedAnswer === generalKnowledgeFullTestCard.correctAnswerIndex) {
            setCountCorrectAnswers((prevCount) => prevCount + 1);
        }
    }, [
        selectedAnswer,
        generalKnowledgeFullTestCard.correctAnswerIndex,
        setCountCorrectAnswers,
    ]);
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="text-cyan-900 md:text-3xl mb-4 font-lato">
                {generalKnowledgeFullTestCard.no} / {generalKnowledgeFullTestQuestionQty}
            </div>
            <div className="border border-teal-800 rounded-lg p-4 md:p-12 flex flex-col items-center">
                {generalKnowledgeFullTestCard.image && (
                    <img
                        className="w-24 h-24 md:w-48 md:h-48 object-contain"
                        src={generalKnowledgeFullTestCard.image}
                ...
                {correctOrWrongAnswerMessage === "Wrong" && (
                    <div className="mt-4 flex flex-col items-center">
                        ...
                        <div className="mt-2 flex justify-center text-center px-4 py-2 bg-green-50 border border-green-300 rounded-lg text-green-800 text-sm md:text-xl font-playfair font-bold shadow-sm">
                            {
                                generalKnowledgeFullTestCard.answers[
                                    generalKnowledgeFullTestCard.correctAnswerIndex
                                ]
                            }
                        </div>
...
export default GeneralKnowledgeFullTestCard;
