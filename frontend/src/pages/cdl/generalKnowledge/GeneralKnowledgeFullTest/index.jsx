...
const GeneralKnowledgeFullTest = () => {
    ...
    const handleSubmit = () => {
        testResult.sendTestResult({
            userId,
            score: String(
                ((correct / generalKnowledgeFullTestData.length) * 100).toFixed(
                    0
                )
            ),
            ...
            pass: ((correct / generalKnowledgeFullTestData.length) * 100).toFixed(0) >= 70,
            requiredScore: "70",
        });
    ...
    const handleAnswerSelect = (questionId, answerIdx) => {
        ...
        const isCorrect =
            generalKnowledgeFullTestData[generalKnowledgeFullTestIdx].correctAnswerIndex ===
            answerIdx;
        ...
        <>
            ...
            {isModalOpen && (
                <ResultModal
                    ...
                    score={(
                        (correct / generalKnowledgeFullTestData.length) *
                        100
                    ).toFixed(0)}
                />
            )}
